---
layout:	single
title: "[Java] 021. 접근 제어자 (Access Modifier)"
excerpt: "접근 제어자 (Access Modifier)"
categories: Java
tag: [STUDY, Java]
toc: true
toc_sticky: true
...
sidebar:
    nav: "docs"
search: true
permalink: categories/java/021-Access-Modifier
# last_modified_at:
---
...
public class C08_AccessModifier extends myobj.C08_DiffPackageClass {
	 ...
	 * 	- default	: 아무 것도 안 적은 것. 같은 패키지 내부에서만 접근할 수 있는 자원
	 ...
	 * 	- 해당 클래스를 다른 개발자가 가져다 사용할 때 잘못된 방식으로 사용하는 것을 방지할 수 있다.
	 */
	...
	public static void main(String[] args) {
		...
		C08_SamePackageClass i1 = new C08_SamePackageClass();

		System.out.println(i1._public_var);
		System.out.println(i1._protected_var);
		System.out.println(i1._default_var);
		
		// 다른 패키지에서 접근할 수 있는 자원 : public
		// 다른 패키지에서 접근할 수 없는 자원 : private, default, protected
...
public class C08_SamePackageClass {
...
public class C08_DiffPackageClass {
	private int _private_var = 10;
	int _default_var = 10;
	protected int _protected_var = 10;
	public int _public_var = 10;
